...
class MinterGrpcApi {
    ...
    getBestTradeGrpc(request, deadline = null) {
        return new Promise((resolve, reject) => {
            this.client.bestTrade(request, new grpc_js_1.Metadata(), this.getOptions(deadline), (err, response) => {
                if (err)
                    reject(err);
                else
                    resolve(response);
    ...
    getCandidateGrpc(request, deadline = null) {
        return new Promise((resolve, reject) => {
            this.client.candidate(request, new grpc_js_1.Metadata(), this.getOptions(deadline), (err, response) => {
                if (err)
                    reject(err);
                else
                    resolve(response);
    ...
    getCandidatesGrpc(request, deadline = null) {
        return new Promise((resolve, reject) => {
            this.client.candidates(request, new grpc_js_1.Metadata(), this.getOptions(deadline), (err, response) => {
                if (err)
                    reject(err);
                else
                    resolve(response);
